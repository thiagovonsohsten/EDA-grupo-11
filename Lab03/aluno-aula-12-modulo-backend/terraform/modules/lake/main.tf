# =============================================================================
# modules/lake — os SEIS recursos, movidos da raiz SEM UMA LINHA DE MUDANCA.
#
# Refatorar e reorganizar, nao rebatizar. Cada "resource" mantem o mesmo tipo e
# o mesmo nome local que tinha na raiz, e so por isso os enderecos casam no
# 'terraform state mv' e o plan final diz "No changes":
#
#   aws_s3_bucket.lake  ->  module.lake.aws_s3_bucket.lake
#
# Os nomes AWS tambem ficaram intactos (eda-a12-${var.sufixo}-*): 'bucket' e
# ForceNew, e trocar o nome destruiria e recriaria o bucket - exatamente o que
# o criterio 1 proibe.
# =============================================================================
